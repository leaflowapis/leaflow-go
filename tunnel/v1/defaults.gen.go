...
const defaultServer = "https://tunnel.leaflow.cloud"

// New returns a Client for the tunnel service. Pass WithBaseURL to override the address.
func New(opts ...ClientOption) (*Client, error) {
	return NewClient(defaultServer, opts...)
}

// NewWithResponses returns a ClientWithResponses for the tunnel service.
