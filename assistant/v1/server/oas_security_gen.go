...
type SecurityHandler interface {
	...
	// A project token. Sign in at auth.leaflow.net for an account token, then exchange it with IAM for a
	// project token (POST /account/v1/projects/{projectId}/token) — one project token states both the
...
var operationRolesBearerAuth = map[string][]string{
	AnswerQuestionOperation:          []string{},
	BeginWeixinLoginOperation:        []string{},
	CheckSenderOperation:             []string{},
	CreateBindingCodeOperation:       []string{},
	CreateChannelOperation:           []string{},
	CreateThreadOperation:            []string{},
	DecideApprovalOperation:          []string{},
	DeleteBindingOperation:           []string{},
	...
	InterruptThreadOperation:         []string{},
	ListBindingsOperation:            []string{},
	ListChannelRejectionsOperation:   []string{},
	...
	MarkThreadReadOperation:          []string{},
	PutSkillOperation:                []string{},
	RevertThreadOperation:            []string{},
	RotateChannelSecretOperation:     []string{},
	SendMessageOperation:             []string{},
	SetSkillEnabledOperation:         []string{},
	SubmitDynamicCallResultOperation: []string{},
	SubmitWeixinVerifyCodeOperation:  []string{},
	UpdateChannelOperation:           []string{},
	UpdateThreadOperation:            []string{},
