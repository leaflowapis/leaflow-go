		...
		case '/': // Prefix: "/api/v1/"
			...
			case 'f': // Prefix: "folders"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleListFoldersRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
			...
			case 's': // Prefix: "skills"
				...
				if len(elem) == 0 {
					...
					case "POST":
						s.handlePutSkillRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "GET,POST",
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "PATCH":
							s.handleSetSkillEnabledRequest([1]string{
								args[0],
							}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
		...
		case '/': // Prefix: "/api/v1/"
			...
			case 'f': // Prefix: "folders"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = ListFoldersOperation
						r.summary = "List folders"
						r.operationID = "list-folders"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/folders"
						r.args = args
						r.count = 0
						return r, true
					case "POST":
						r.name = CreateFolderOperation
						r.summary = "Create a folder"
						r.operationID = "create-folder"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/folders"
						r.args = args
						r.count = 0
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "PATCH":
							...
							r.summary = "Rename a folder"
							r.operationID = "update-folder"
							r.operationGroup = ""
							r.pathPattern = "/api/v1/folders/{folder}"
							r.args = args
							r.count = 1
				...
				case 'o': // Prefix: "odels"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "List assistant model choices"
			...
			case 's': // Prefix: "skills"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "List the skills this project can use"
						r.operationID = "list-skills"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/skills"
						r.args = args
						r.count = 0
						return r, true
					case "POST":
						r.name = PutSkillOperation
						r.summary = "Write a skill for this project"
						r.operationID = "put-skill"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/skills"
						r.args = args
						r.count = 0
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "DELETE":
							...
							r.summary = "Delete this project's skill"
							r.operationID = "delete-skill"
							r.operationGroup = ""
							r.pathPattern = "/api/v1/skills/{skill}"
							r.args = args
							r.count = 1
							return r, true
						case "GET":
							r.name = GetSkillOperation
							r.summary = "Read one skill, with its files"
							r.operationID = "get-skill"
							r.operationGroup = ""
							r.pathPattern = "/api/v1/skills/{skill}"
							r.args = args
							r.count = 1
							return r, true
						case "PATCH":
							r.name = SetSkillEnabledOperation
							r.summary = "Turn a skill on or off"
							r.operationID = "set-skill-enabled"
							r.operationGroup = ""
							r.pathPattern = "/api/v1/skills/{skill}"
							r.args = args
							r.count = 1
