						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								case "GET":
									...
									r.operationGroup = ""
									r.pathPattern = "/api/v1/plans/{planId}"
									r.args = args
									r.count = 1
									return r, true
								default:
							...
							case '/': // Prefix: "/prices"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.operationGroup = ""
										r.pathPattern = "/api/v1/plans/{planId}/prices"
										r.args = args
										r.count = 1
										return r, true
									default:
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.operationGroup = ""
										r.pathPattern = "/api/v1/prices/{priceId}"
										r.args = args
										r.count = 1
										return r, true
									default:
					...
					case '/': // Prefix: "/rules"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.operationGroup = ""
								r.pathPattern = "/api/v1/rate-cards/{rateCardId}/rules"
								r.args = args
								r.count = 1
								return r, true
							default:
