...
func encodeCancelScheduledChangeResponse(response *Order, w http.ResponseWriter, span trace.Span) error {
...
func encodeGetInvoiceRefundQuoteResponse(response *RefundQuote, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
...
func encodeGetOrderRefundQuoteResponse(response *RefundQuote, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
