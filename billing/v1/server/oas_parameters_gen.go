...
// GetCatalogPlanParams is parameters of get-catalog-plan operation.
...
func unpackGetCatalogPlanParams(packed middleware.Parameters) (params GetCatalogPlanParams) {
	{
		key := middleware.ParameterKey{
			Name: "If-None-Match",
			In:   "header",
...
func decodeGetCatalogPlanParams(args [1]string, argsEscaped bool, r *http.Request) (params GetCatalogPlanParams, _ error) {
...
// GetCatalogPriceParams is parameters of get-catalog-price operation.
...
func unpackGetCatalogPriceParams(packed middleware.Parameters) (params GetCatalogPriceParams) {
	{
		key := middleware.ParameterKey{
			Name: "If-None-Match",
			In:   "header",
...
func decodeGetCatalogPriceParams(args [1]string, argsEscaped bool, r *http.Request) (params GetCatalogPriceParams, _ error) {
	h := uri.NewHeaderDecoder(r.Header)
	// Decode header: If-None-Match.
	if err := func() error {
		cfg := uri.HeaderParameterDecodingConfig{
...
// GetCatalogProductParams is parameters of get-catalog-product operation.
...
func unpackGetCatalogProductParams(packed middleware.Parameters) (params GetCatalogProductParams) {
	{
		key := middleware.ParameterKey{
			Name: "If-None-Match",
			In:   "header",
...
func decodeGetCatalogProductParams(args [1]string, argsEscaped bool, r *http.Request) (params GetCatalogProductParams, _ error) {
	h := uri.NewHeaderDecoder(r.Header)
	// Decode header: If-None-Match.
	if err := func() error {
		cfg := uri.HeaderParameterDecodingConfig{
...
// ListCatalogItemsParams is parameters of list-catalog-items operation.
type ListCatalogItemsParams struct {
	...
	Type OptListCatalogItemsType `json:",omitempty,omitzero"`
}
...
func unpackListCatalogItemsParams(packed middleware.Parameters) (params ListCatalogItemsParams) {
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.Type = v.(OptListCatalogItemsType)
		}
	}
	return params
}

func decodeListCatalogItemsParams(args [0]string, argsEscaped bool, r *http.Request) (params ListCatalogItemsParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	h := uri.NewHeaderDecoder(r.Header)
	// Decode query: page.
	if err := func() error {
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotTypeVal ListCatalogItemsType
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotTypeVal = ListCatalogItemsType(c)
					return nil
				}(); err != nil {
					return err
				}
