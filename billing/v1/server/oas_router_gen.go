							...
							case '/': // Prefix: "/"
								...
								case '/': // Prefix: "/"
									...
									case 'r': // Prefix: "renew"
										...
										switch elem[0] {
										case 'a': // Prefix: "al-prices"

											if l := len("al-prices"); len(elem) >= l && elem[0:l] == "al-prices" {
												elem = elem[l:]
											} else {
												break
											}
			...
			case 'c': // Prefix: "catalog/v1/"
				...
				case 'i': // Prefix: "items"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleListCatalogItemsRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "GET",
				...
				case 'p': // Prefix: "p"
					...
					case 'l': // Prefix: "lans/"
						...
						if len(elem) == 0 {
							switch r.Method {
							case "GET":
								s.handleGetCatalogPlanRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
					...
					case 'r': // Prefix: "r"
						...
						case 'i': // Prefix: "ices/"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleGetCatalogPriceRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
						...
						case 'o': // Prefix: "oducts"
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									switch r.Method {
									case "GET":
										s.handleGetCatalogProductRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
										...
										case 'a': // Prefix: "al-prices"
											...
											if len(elem) == 0 {
												...
												case "GET":
													...
													r.operationGroup = ""
													r.pathPattern = "/account/v1/subscription-items/{itemId}/renewal-prices"
													r.args = args
													r.count = 1
													return r, true
												default:
				...
				case 'i': // Prefix: "items"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.operationID = "list-catalog-items"
							r.operationGroup = ""
							r.pathPattern = "/catalog/v1/items"
							r.args = args
							r.count = 0
							return r, true
						default:
				...
				case 'p': // Prefix: "p"
					...
					case 'l': // Prefix: "lans/"
						...
						if len(elem) == 0 {
							switch method {
							case "GET":
								r.name = GetCatalogPlanOperation
								r.summary = "Get a sellable item"
								r.operationID = "get-catalog-plan"
								r.operationGroup = ""
					...
					case 'r': // Prefix: "r"
						...
						case 'i': // Prefix: "ices/"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = GetCatalogPriceOperation
									r.summary = "Get a price"
									r.operationID = "get-catalog-price"
									r.operationGroup = ""
						...
						case 'o': // Prefix: "oducts"
							...
							case '/': // Prefix: "/"
								...
								if len(elem) == 0 {
									switch method {
									case "GET":
										r.name = GetCatalogProductOperation
										r.summary = "Get a service"
										r.operationID = "get-catalog-product"
										r.operationGroup = ""
