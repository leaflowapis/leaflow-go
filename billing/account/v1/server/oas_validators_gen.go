...
func (s *CancellationCreate) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	if err := func() error {
		...
		if err := (validate.Array{
			...
			MaxLength:    50,
			MaxLengthSet: true,
		}).ValidateLength(len(s.SubscriptionIds)); err != nil {
			return errors.Wrap(err, "array")
		}
		if err := validate.UniqueItems(s.SubscriptionIds); err != nil {
			return errors.Wrap(err, "array")
		}
		return nil
	}(); err != nil {
...
func (s *CancellationItem) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s CancellationItemStatus) Validate() error {
	switch s {
	case "requested":
		return nil
	case "scheduled":
...
func (s *CancellationList) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s CancellationOrigin) Validate() error {
	switch s {
	case "customer":
		return nil
	case "operator":
...
func (s *CancellationRefundPreviewItem) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s CancellationStatus) Validate() error {
	switch s {
	case "requested":
		return nil
	case "scheduled":
...
func (s *CreateCancellationOK) Validate() error {
	alias := (*Cancellation)(s)
	if err := alias.Validate(); err != nil {
		return err
	}
...
func (s ListCancellationsStatus) Validate() error {
	switch s {
	case "open":
		return nil
	case "requested":
...
func (s *PaymentPreview) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *QuoteCancellation) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *RenewalOrderRequest) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s RenewalOrderRequestInterval) Validate() error {
	switch s {
	case "day":
		return nil
	case "month":
