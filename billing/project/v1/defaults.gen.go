...
package billingprojectv1

const defaultServer = "https://billing.leaflow.cloud"

// New returns a Client for the billing project service. Pass WithBaseURL to override the address.
func New(opts ...ClientOption) (*Client, error) {
	return NewClient(defaultServer, opts...)
}

// NewWithResponses returns a ClientWithResponses for the billing project service.
