...
var operationRolesBearerAuth = map[string][]string{
	...
	DeleteUserChannelOperation:             []string{},
	DescribeCredentialTicketOperation:      []string{},
	DescribeRealtimeConnectionOperation:    []string{},
	GetNotificationOperation:               []string{},
	GetNotificationPreferencesOperation:    []string{},
	ListAnnouncementsOperation:             []string{},
	ListNotificationsOperation:             []string{},
	ListTypePreferencesOperation:           []string{},
	ListUserChannelsOperation:              []string{},
	MarkNotificationReadOperation:          []string{},
	MarkNotificationUnreadOperation:        []string{},
	...
	UpdateUserChannelOperation:             []string{},
	VerifyUserChannelOperation:             []string{},
}
