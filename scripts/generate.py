...
SHARED_SPECS = ("type/v1/error.yaml", "type/v1/identity.yaml", "type/v1/money.yaml", "type/v1/order.yaml",
                "type/v1/pagination.yaml", "type/v1/resource.yaml", "type/v1/task.yaml",
                "type/v1/translations.yaml")
